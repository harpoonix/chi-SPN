...
def create_spn_model(num_prediction_vars, num_condition_vars, seed, nn_provider=None, setup="base", nn_provider_args=None):
    rg = RegionGraph(num_prediction_vars, num_permutations=setups[setup]["num_permutations"],
                     num_splits=2, max_depth=2, rng_seed=seed)
