...
class TabularDataset:
    ...
    def __init__(self, dataset_paths, X_vars, Y_vars, seed=None,
                 store_as_torch_tensor=True, part_transformer=None):
        ...
        for data_path in dataset_paths:
            with open(data_path, "rb") as f:
                data = pickle.load(f)
                if part_transformer is not None:
                    part_transformer(data_path, data)
