...
models = [("ciCNNSPN", "NLLLoss", ""), ("cnn", "MSELoss", "_noInterventions"), ("cnn", "causalLoss", "")]
...
for dataset in datasets:
    ...
    for model, loss, ext_str in models:
        file_names = [f"../../experiments/E2/{eval_folder}/E2_{dataset}_{model}_{loss}{ext_str}/{seed}.txt" for seed in seeds]
...
if combined:
    ...
    for dataset in datasets:
        ...
        for idx, factor in enumerate(factors):
            file_names = [f"../../experiments/E2/{eval_folder}/E2_{dataset}_cnn_MSELoss_causalLoss_{factor}/{seed}.txt" for seed in seeds]
            mean, std = experiment_stats(file_names)
...
for dataset in datasets:
    ...
    display_models = [*models, ("combined", None, "")] if combined else models
    for model, loss, ext_str in display_models:
